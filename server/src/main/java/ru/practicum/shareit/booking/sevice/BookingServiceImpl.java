...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<BookingResponseDto> getBookingsByOwner(Long userId, BookingState state, Integer from, Integer size) {
        ...
        List<BookingResponseDto> bookings = switch (state) {
            case CURRENT ->
                    bookingRepository.findByItemOwnerIdAndStartBeforeAndEndAfter(userId, now, now, pageable)
                            .stream()
